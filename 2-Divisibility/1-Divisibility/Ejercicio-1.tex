...
\problema{ }\label{pro:1}
	...
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{120}{5}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $5$ si divide a $120$\QEPD
	\part
	Haciendo un procedimiento clásico de división:\\
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{165}{11}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $11$ si divide a $165$\QEPD
	\part
	Haciendo un procedimiento clásico de división:\\
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{98}{14}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $14$ si divide a $98$\QEPD
\end{document}