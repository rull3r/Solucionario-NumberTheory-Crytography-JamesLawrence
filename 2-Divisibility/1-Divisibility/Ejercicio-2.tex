...
\problema{ }\label{pro:1}
	...
	\solution 
	\part
	$7=7*1$. Entonces con $c=1$ tenemos que se cumple la definición de divisibilidad\QEPD
	\part
	Haciendo un procedimiento clásico de división:\\
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{25}{10}
	\end{center}
	Obtenemos que el resto es $5$ por lo tanto $10$ no divide a $25$\QEPD
	\part
	Haciendo un procedimiento clásico de división:\\
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{160}{32}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $32$ si divide a $-160$\QEPD
\end{document}