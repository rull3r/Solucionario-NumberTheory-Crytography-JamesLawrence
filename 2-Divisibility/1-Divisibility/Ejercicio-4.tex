...
\problema{ }\label{pro:1}
	...
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{63}{3}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $3$ si divide a $63$\QEPD
	\part
	Haciendo un procedimiento clásico de división:\\
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{27}{9}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $9$ si divide a $27$\QEPD
	\part
	Haciendo un procedimiento clásico de división:\\
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{54}{18}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $18$ si divide a $54$\QEPD
	\part
	Haciendo un procedimiento clásico de división:\\
	\begin{center}
		\intlongdivision[german division sign = $\,\div\,$]{150}{10}
	\end{center}
	Obtenemos que el resto es $0$ por lo tanto $10$ si divide a $150$\QEPD
\end{document}